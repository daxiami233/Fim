...
import fs from 'fs';
import { CallGraphNode, FileSignature, MethodSignature, ViewTreeNode } from 'arkAnalyzer/src';
...
// build from json
const jsonFile = './tests/routerTest/RouterTestConfig.json';
...
function readMainPagesFromJson(fileName: string): string[] {
    ...
    console.log(`projectName: ${targetProjectDirectory}`);
