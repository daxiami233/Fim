...
import { NodeBuilder } from '../src/core/model/builder/nodeBuilder/NodeBuilder';
import { RouterMapNodeBuilder } from '../src/core/model/builder/nodeBuilder/RouterMapNodeBuilder';


let config: SceneConfig = new SceneConfig()
config.buildFromJson('./main/config.json');
...
function runScene(config: SceneConfig) {
    ...
    ptgModelBuilder.addNodeBuilder(new NodeBuilder(projectScene,ptg))
